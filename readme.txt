=== Auto Load Next Post: Easy Fancybox ===
...
Enables Easy Fancybox to be ready when a post is loaded to allow new media links to be active.
...
* [GitHub](https://github.com/autoloadnextpost/alnp-addon-boilerplate)

== Installation ==

Installing "Auto Load Next Post: Easy Fancybox" can be done either by searching for "Auto Load Next Post" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
